...
if __name__ == "__main__":
    ...
    # Add movies
    system.add_movie("The vampire diaries", "Drama", 9.0)
    system.add_movie("The originals", "Drama", 8.7)
    system.add_movie("Interstellar", "Sci-Fi", 8.6)
    system.add_movie("CID", "Crime", 9.2)
    system.add_movie("Singham", "Action", 9.0)
